...
namespace Automation.API.Framework
{
    ...
    public sealed class Hooks
    {
        ...
        static string baseurl = Properties.URL;
        static string testExecution = Properties.testExecution;
        ...
        public static void SetUp()
        {
            ...
            Properties.SetBaseUrl(EnvirnomentConfig.TestEnvirnoment);
        ...
        public static void BeforeFeature()
        {
            ...
            if (testExecution == "firefox") // headlessrun is performed on deployment server.
            {
